...
?>
        ...
        <!-- *********************************************************** -->
        <!-- Formstone Scroller -->
        <script src="//cetec1.net/lms/my_assets/jquery/jqPlugins/scroller-master/demo.js"></script>
        <script src="//cetec1.net/lms/my_assets/jquery/jqPlugins/scroller-master/modernizr.js"></script>
        <link href="//cetec1.net/lms/my_assets/jquery/jqPlugins/scroller-master/jquery.fs.scroller.css" rel="stylesheet" type="text/css" media="all">
        <!-- Scroller -->
        <script src="//cetec1.net/lms/my_assets/jquery/jqPlugins/scroller-master/jquery.fs.scroller.js"></script>
        ...
        <style>
            .scrollbar { /*border: 1px solid #eee;*/ width:500px; height: 200px; overflow: auto; margin: 20px 0 0; padding: 10px 20px 10px 20px;}
            .scrollbar.scroller { padding: 0; }
            .scrollbar.scroller .scroller-content,	.scrollbar.scroller-active .scroller-content { padding: 20px 40px 20px 20px; }
            ...
            .advanced .scroller-handle { background: #900; border: none; border-radius: 0; right: 0; width: 100%; }
        </style>
        ...
        <!-- TOC layout -->
        <div id="toc_id" name="toc_name" style="overflow: auto; padding:0;margin-top:0px;width:100%;float:left" class="scrollbar">
            <div id="learning_path_toc" calss="scrollbar">
